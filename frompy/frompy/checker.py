...
FineGrainedDeferredNodeType = Union[FuncDef, FrompyFile, OverloadedFuncDef]
...
class TypeChecker(NodeVisitor[None], CheckerPluginInterface):
    ...
    def check_top_level(self, node: FrompyFile) -> None:
    ...
    def intersect_instances(
        ...
        assert isinstance(curr_module, FrompyFile)
    ...
    def intersect_instance_callable(
        ...
        cur_module = cast(FrompyFile, self.scope.stack[0])
    ...
    def lookup(self, name: str, kind: int) -> SymbolTableNode:
        ...
        if name in self.globals:
            ...
            if b:
                table = cast(FrompyFile, b.node).names
                if name in table:
                    return table[name]
...
class CheckerScope:
    ...
    stack = None  # type: List[Union[TypeInfo, FuncItem, FrompyFile]]

    def __init__(self, module: FrompyFile) -> None:
        self.stack = [module]
