...
def extract_refexpr_names(expr: RefExpr) -> Set[str]:
    ...
    while isinstance(expr.node, FrompyFile) or expr.fullname is not None:
        if isinstance(expr.node, FrompyFile) and expr.fullname is not None:
