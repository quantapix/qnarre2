...
# This must include all reporters defined in frompy.report. This is defined here
# to make reporter names available without importing frompy.report -- this speeds
# up startup.
REPORTER_NAMES = [
    "linecount",
    "any-exprs",
