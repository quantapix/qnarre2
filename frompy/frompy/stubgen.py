...
class StubSource(BuildSource):
    ...
    def __init__(
        ...
        self.ast = None  # type: Optional[FrompyFile]
...
def find_defined_names(file: FrompyFile) -> Set[str]:
...
def find_referenced_names(file: FrompyFile) -> Set[str]:
...
class StubGenerator(mypy.traverser.TraverserVisitor):
    ...
    def is_alias_expression(self, expr: Expression, top_level: bool = True) -> bool:
        ...
        if (
            ...
            return (
                top_level
                and isinstance(expr.node, (FuncDef, Decorator, FrompyFile))
