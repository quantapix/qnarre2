...
from py2jl.common import PREFIX, NATIVE_PREFIX, DUNDER_PREFIX
from py2jl.codegen.emit import Emitter
from py2jl.ir.rtypes import (
    RType, is_object_rprimitive, is_int_rprimitive, is_bool_rprimitive, object_rprimitive
)
from py2jl.ir.func_ir import FuncIR, RuntimeArg, FUNC_STATICMETHOD
