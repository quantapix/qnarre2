...
from py2jl.common import short_name

if TYPE_CHECKING:
    from py2jl.ir.class_ir import ClassIR  # noqa
    from py2jl.ir.func_ir import FuncIR, FuncDecl  # noqa
...
import py2jl.primitives.registry  # noqa
