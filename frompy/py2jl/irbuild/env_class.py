...
from py2jl.ir.ops import Call, GetAttr, SetAttr, Value, Environment, AssignmentTargetAttr
...
from py2jl.irbuild.context import FuncInfo, ImplicitClass, GeneratorClass
