...
from py2jl.test.testutil import Py2jlDataSuite, assert_test_output
...
class TestCommandLine(Py2jlDataSuite):
    files = files
    ...
    def run_case(self, testcase: DataDrivenTestCase) -> None:
        ...
        try:
            # Compile program
            cmd = subprocess.run(
                [sys.executable, os.path.join(base_path, "scripts", "mypyc")] + args,
