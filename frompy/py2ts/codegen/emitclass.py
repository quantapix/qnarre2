...
from py2ts.common import PREFIX, NATIVE_PREFIX, REG_PREFIX
from py2ts.codegen.emit import Emitter, HeaderDeclaration
from py2ts.codegen.emitfunc import native_function_header
...
from py2ts.ir.rtypes import RType, RTuple, object_rprimitive
from py2ts.ir.func_ir import FuncIR, FuncDecl, FUNC_STATICMETHOD, FUNC_CLASSMETHOD
from py2ts.ir.class_ir import ClassIR, VTableEntries
