...
from frompy.types import Type, Instance, TupleType, UninhabitedType, get_proper_type
...
from py2ts.common import TEMP_ATTR_NAME
from py2ts.irbuild.prebuildvisitor import PreBuildVisitor
...
from py2ts.ir.func_ir import FuncIR, INVALID_FUNC_DEF
from py2ts.ir.class_ir import ClassIR, NonExtClassInfo
from py2ts.primitives.registry import func_ops
from py2ts.primitives.list_ops import list_len_op, to_list, list_pop_last
from py2ts.primitives.dict_ops import dict_get_item_op, dict_set_item_op
from py2ts.primitives.generic_ops import py_setattr_op, iter_op, next_op
from py2ts.primitives.misc_ops import true_op, false_op, import_op
...
from py2ts.irbuild.ll_builder import LowLevelIRBuilder
from py2ts.irbuild.util import is_constant
...
class IRBuilder:
    ...
    def is_module_member_expr(self, expr: MemberExpr) -> bool:
        return isinstance(expr.expr, RefExpr) and isinstance(expr.expr.node, FrompyFile)
