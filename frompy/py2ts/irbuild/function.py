...
from py2ts.ir.rtypes import object_rprimitive, RInstance
...
from py2ts.primitives.generic_ops import py_setattr_op, next_raw_op, iter_op
from py2ts.primitives.misc_ops import check_stop_op, yield_from_except_op, coro_op, send_op
from py2ts.primitives.dict_ops import dict_set_item_op
from py2ts.common import SELF_NAME, LAMBDA_NAME, decorator_helper_name
from py2ts.sametype import is_same_method_signature
from py2ts.irbuild.util import concrete_arg_kind, is_constant, add_self_to_env
from py2ts.irbuild.context import FuncInfo, ImplicitClass
from py2ts.irbuild.statement import transform_try_except
from py2ts.irbuild.builder import IRBuilder, gen_arg_defaults
from py2ts.irbuild.callable_class import (
    setup_callable_class, add_call_to_callable_class, add_get_to_callable_class,
    instantiate_callable_class
)
from py2ts.irbuild.generator import (
...
from py2ts.irbuild.env_class import (
