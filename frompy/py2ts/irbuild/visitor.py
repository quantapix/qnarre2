...
from py2ts.ir.ops import Value
from py2ts.irbuild.builder import IRVisitor, IRBuilder, UnsupportedException
from py2ts.irbuild.classdef import transform_class_def
from py2ts.irbuild.function import (
    transform_func_def,
...
from py2ts.irbuild.statement import (
    transform_block,
...
from py2ts.irbuild.expression import (
    transform_name_expr,
