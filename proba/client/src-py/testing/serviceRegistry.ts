...
import { DebugLauncher } from './utils/miscLauncher';
...
export function registerTypes(serviceManager: IServiceManager) {
  ...
  serviceManager.add<ITestDiscoveredTestParser>(
    ITestDiscoveredTestParser,
  ...
  serviceManager.addSingleton<ITestContextService>(
    ITestContextService,
    TestContextService
  );
  serviceManager.addSingleton<ITestsStatusUpdaterService>(
    ITestsStatusUpdaterService,
  ...
  serviceManager.addSingleton<ITestManagementService>(
    ITestManagementService,
  ...
  serviceManager.addSingleton<ITestDiagnosticService>(
    ITestDiagnosticService,
  ...
  serviceManager.addSingleton<ITestTreeViewProvider>(
    ITestTreeViewProvider,
    TestTreeViewProvider
  );
  serviceManager.addSingleton<ITestDataItemResource>(
    ITestDataItemResource,
    TestTreeViewProvider
  );
  serviceManager.addSingleton<ITestExplorerCommandHandler>(
    ITestExplorerCommandHandler,
