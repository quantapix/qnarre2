...
export class PythonSettings implements IPythonSettings {
  ...
  public static getInstance(
    ...
    const workspaceFolderUri = PythonSettings.getSettingsUriAndTarget(resource, workspace)
      .uri;
  ...
  protected update(pythonSettings: WorkspaceConfiguration) {
    ...
    this.defaultInterpreterPath = defaultInterpreterPath
    ...
    this.testing.nosetestArgs = this.testing.nosetestArgs.map((arg) =>
  ...
  protected initialize(): void {
    ...
    this.disposables.push(
      this.workspace.onDidChangeWorkspaceFolders(this.onWorkspaceFoldersChanged, this)
    );
    this.disposables.push(
    ...
    if (this.interpreterSecurityService) {
      this.disposables.push(
        this.interpreterSecurityService.onDidChangeSafeInterpreters(
          onDidChange.bind(this)
        )
      );
    }
    ...
    if (this.interpreterPathService) {
      this.disposables.push(
        this.interpreterPathService.onDidChange(onDidChange.bind(this))
      );
    }
  ...
  private getPythonPath(
     ...
     */
    const inExperiment = this.experimentsManager?.inExperiment(
