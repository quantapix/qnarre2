...
import { IFileDownloader, IHttpClient, IInterpreterPathService } from './types';
...
export function registerTypes(serviceManager: IServiceManager) {
  ...
  serviceManager.addSingleton<IExperimentsManager>(
    IExperimentsManager,
    ExperimentsManager
  );
  ...
  serviceManager.addSingleton<IInsiderExtensionPrompt>(
    IInsiderExtensionPrompt,
  ...
  serviceManager.addSingleton<ICustomEditorService>(
    ICustomEditorService,
    CustomEditorService
  );
}
