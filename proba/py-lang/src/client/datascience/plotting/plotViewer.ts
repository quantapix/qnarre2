...
@injectable()
export class PlotViewer extends WebViewHost<IPlotViewerMapping>
  ...
  constructor(
    ...
    super(
      ...
      plotDir,
      [
        path.join(plotDir, 'commons.initial.bundle.js'),
  ...
  private async exportPlot(payload: IExportPlotRequest): Promise<void> {
    ...
    try {
      ...
      this.applicationShell.showErrorMessage(
        localize.DataScience.exportImageFailed().format(e)
      );
    }
  }
}
