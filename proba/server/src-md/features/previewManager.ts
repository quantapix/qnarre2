...
export class MarkdownPreviewManager extends Disposable
  ...
  public constructor(
    ...
    super();
    this._register(
      vscode.window.registerWebviewPanelSerializer(DynamicMarkdownPreview.viewType, this)
    );
    this._register(
      vscode.window.registerCustomEditorProvider(this.customEditorViewType, this)
    );
  }
  ...
  private registerDynamicPreview(
    ...
    preview.onDidChangeViewState(() => {
      ...
      disposeAll(
        Array.from(this._dynamicPreviews).filter(
  ...
  private setPreviewActiveContext(value: boolean) {
    vscode.commands.executeCommand(
      'setContext',
      MarkdownPreviewManager.markdownPreviewActiveContextKey,
      value
    );
  }
}
