...
export class ExtensionContentSecurityPolicyArbiter
  ...
  public getSecurityLevelForResource(resource: vscode.Uri): MarkdownPreviewSecurityLevel {
    ...
    const level = this.globalState.get<MarkdownPreviewSecurityLevel | undefined>(
          ...
          label:
            markActiveWhen(
              currentSecurityLevel ===
                MarkdownPreviewSecurityLevel.AllowInsecureLocalContent
            ) + localize('insecureLocalContent.title', 'Allow insecure local content'),
