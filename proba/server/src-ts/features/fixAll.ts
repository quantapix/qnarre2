...
class TypeScriptAutoFixProvider implements vscode.CodeActionProvider {
  ...
  public async provideCodeActions(
    ...
    const fixAllAction = await this.getFixAllCodeAction(
      document,
      file,
  ...
  private getAutoFixableDiagnostics(document: vscode.TextDocument): vscode.Diagnostic[] {
  ...
  private async getAutoFixEdit(
    ...
    { edit: vscode.WorkspaceEdit; fixedDiagnostics: vscode.Diagnostic[] } | undefined
  > {
  ...
  return new VersionDependentRegistration(
    ...
    () =>
      new ConfigurationDependentRegistration(
        'typescript',
        'experimental.autoFix.enabled',
        () =>
          vscode.languages.registerCodeActionsProvider(
            selector,
            new TypeScriptAutoFixProvider(
              client,
