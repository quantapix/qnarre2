...
class FindSymbolTreeWalker extends ParseTreeWalker {
  ...
  private _addSymbolInformationFromDeclaration(
    name: string,
    ...
    const resolvedSymbol = this._evaluator.resolveAliasDeclaration(
      declaration,
...
function getSymbolKind(
  ...
  switch (declaration.type) {
    ...
    case DeclarationType.Variable:
      ...
      symbolKind =
        declaration.isConstant || declaration.isFinal
          ? SymbolKind.Constant
          : SymbolKind.Variable;
      break;
...
export class DocumentSymbolProvider {
  static addSymbolsForDocument(
    ...
    const symbolTreeWalker = new FindSymbolTreeWalker(
      filePath,
      parseResults,
      symbolList,
      query,
