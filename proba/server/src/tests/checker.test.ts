...
test('Builtins1', () => {
  ...
  const moduleScope = AnalyzerNodeInfo.getScope(
    analysisResults[0].parseResults!.parseTree
  )!;
...
test('Function3', () => {
  ...
  const analysisResults37 = TestUtils.typeAnalyzeSampleFiles(
    ['function3.py'],
    configOptions
  );
  ...
  const analysisResults38 = TestUtils.typeAnalyzeSampleFiles(
    ['function3.py'],
    configOptions
  );
...
test('Unions1', () => {
  ...
  const analysisResults39 = TestUtils.typeAnalyzeSampleFiles(
    ['unions1.py'],
    configOptions
  );
