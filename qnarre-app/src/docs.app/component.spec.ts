...
describe('AppComp', () => {
  ...
  function initializeTest(waitForDoc = true) {
    ...
    const docViewerDe = de.query(By.css('qnr-doc-viewer'));
  ...
  describe('with proper DocViewer', () => {
    ...
    describe('auto-scrolling', () => {
      ...
      beforeEach(() => {
        ...
        removeStoredScrollInfoSpy = spyOn(
          scrollService,
    ...
    describe('qnr-toc', () => {
      ...
      const setHasFloatingToc = (hasFloatingToc: boolean) => {
        ...
        toc = tocContainer && tocContainer.querySelector('qnr-toc');
      };
      ...
      it('should show/hide `<qnr-toc>` based on `hasFloatingToc`', () => {
      ...
      it('should have a non-embedded `<qnr-toc>` element', () => {
        setHasFloatingToc(true);
      ...
      it('should not be loaded/registered until necessary', () => {
        const loader = (fixture.debugElement.injector.get(
          ElementsLoader
        ) as unknown) as TestElementsLoader;
        expect(loader.loadCustomElement).not.toHaveBeenCalled();

        setHasFloatingToc(true);
        expect(loader.loadCustomElement).toHaveBeenCalledWith('qnr-toc');
      });
    });
    ...
    describe('archive redirection', () => {
      ...
      Object.keys(redirectionPerMode).forEach(mode => {
        ...
        it(description, () => {
          ...
          const testCurrentNodes = (navService.currentNodes = new Subject<
            CurrentNodes
          >());
  ...
  describe('with mocked DocViewer', () => {
    const getDocViewer = () =>
      fixture.debugElement.query(By.css('qnr-doc-viewer'));
