...
@NgModule({
  ...
  declarations: [ApiListComp],
  entryComponents: [ApiListComp],
  providers: [ApiService]
})
export class ApiListModule implements WithElem {
  elemComp: Type<any> = ApiListComp;
}
