...
import {LiveComp} from './live';

const defaultTestPath = '/test';

describe('LiveComp', () => {
  let liveExampleDe: DebugElement;
  let liveExampleComponent: LiveComp;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [HostComponent, LiveComp],
  ...
  describe('when not embedded', () => {
    ...
    it('should create LiveComp', () => {
      testComponent(() => {
        expect(liveExampleComponent).toBeTruthy('LiveComp');
      });
    });
