    ...
    const docs = [
      {
        ...
        docType: 'test',
        renderedContent:
          '<a href="orange"></a><a href="apple"></a><a href="banana"></a>'
      }
    ];
    processor.$process(docs);
    expect(docs).toEqual([
    ...
    const docs = [
      {
        ...
        docType: 'test',
        renderedContent:
          '<a href="banana"></a><a href="apple"></a><a href="banana"></a>'
      }
    ];
    processor.$process(docs);
    expect(docs).toEqual([
    ...
    const docs = [
      {
        ...
        docType: 'test',
        renderedContent:
          '<a href="https://www.google.com"></a><a href="apple"></a><a href="ftp://myfile.org"></a>'
      }
    ];
    processor.$process(docs);
    expect(docs).toEqual([
  ...
  it('should add HTML comments for links into docs', () => {
    ...
    expect(docs).toEqual([
      ...
      },
      {
        ...
        docType: 'test',
        renderedContent:
          '<a href="test-1"></a><a href="test-3"></a>\n' +
          '<!-- links to this doc:\n - test-1\n - test-3\n-->\n' +
          '<!-- links from this doc:\n - test-1\n - test-3\n-->'
      },
      {
  ...
  it('should match links that contain fragments or queries', () => {
    ...
    expect(docs).toEqual([
      ...
      },
      {
        ...
        docType: 'test',
        renderedContent:
          '<a href="test-1?some-query#foo"></a>\n' +
          '<!-- links to this doc:\n-->\n' +
