...
@Component({
  selector: 'qnr-graph-debug-card',
  templateUrl: './debug-card.html',
  styleUrls: ['./debug-card.scss']
})
export class DebugCardComp implements OnInit {
  ...
  ready() {
    ...
    const scrollbarContainer = document.querySelector(
      'qnr-graph-dash-layout .scrollbar'
    );
