...
import {PluginInfo, PLUGINS_KEY} from '../app/types';
...
describe('plugins.component', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      providers: [provideMockStore({initialState}), Plugins],
      declarations: [Plugins, PluginsComp]
  ...
  describe('plugin DOM creation', () => {
    ...
    it('creates no plugin when there is no activePlugin', () => {
      const c = TestBed.createComponent(Plugins);
