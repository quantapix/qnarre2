...
def test_class_decorators():
    ...
    assert [[1, 2, 3], True, True] == eval_object_es6(
        test_class_deco, "test_class_deco();"
    )
...
def test_for_of():
    ...
    assert [[1, 2, 3, 4, 5], ["a", "b"]] == eval_object_es6(
        test_forof_js, "test_forof_js();"
    )
...
def test_for_inherited():
    ...
    assert [[], ["bar2", "bar"], ["bar2"], ["bar2", "bar"]] == eval_object_es6(
        test_for_inh, "test_for_inh();"
    )
...
def test_assert():
    ...
    assert {"message": "Error raised", "name": "PJAssertionError"} == eval_object(
        test_ass, "test_ass();"
    )
