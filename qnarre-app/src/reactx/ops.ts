...
export function dematerialize<T>(): OperatorFunction<Notification<T>, T> {
  return function dematerializeOperatorFunction(
...
export function multicast<T, R>(
  ...
  return function multicastOperatorFunction(
    source: Observable<T>
  ): Observable<R> {
...
export function observeOn<T>(
  ...
  return function observeOnOperatorFunction(
    source: Observable<T>
  ): Observable<T> {
...
export function reduce<V, A>(
  ...
  if (arguments.length >= 2) {
    return function reduceOperatorFunctionWithSeed(
      source: Observable<V>
    ): Observable<V | A> {
      return pipe(
  ...
  return function reduceOperatorFunction(
    source: Observable<V>
  ): Observable<V | A> {
    return pipe(
...
export function refCount<T>(): MonoTypeOperatorFunction<T> {
  return function refCountOperatorFunction(
...
export function subscribeOn<T>(
  ...
  return function subscribeOnOperatorFunction(
    source: Observable<T>
  ): Observable<T> {
