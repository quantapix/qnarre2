...
function postProcessOutputMessage(msg: TestMessage) {
  if (
    Array.isArray(msg.notification.value) &&
    ...
    let completionFrame = msg.notification.value.messages.reduce(function (
      prev: number,
      x: TestMessage
    ) {
