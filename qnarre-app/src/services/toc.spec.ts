...
import {ScrollItem, ScrollSpyInfo, ScrollSpyService} from './scroll-spy';
import {TocItem, TocService} from './toc';
...
describe('TocService', () => {
  ...
  describe('when given many headings', () => {
    ...
    it('should have "SafeHtml" content which is heading\'s innerHTML ', () => {
      ...
      expect(
        (content as TestSafeHtml).changingThisBreaksApplicationSecurity
  ...
  describe('TocItem for an h2 with links and extra whitespace', () => {
    ...
    it('should have removed anchor link and GitHub links from tocItem html content', () => {
      expect(
        (tocItem.content as TestSafeHtml).changingThisBreaksApplicationSecurity
