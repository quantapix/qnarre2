...
describe('ContribService', () => {
  ...
  let contribService: ContribService;
  ...
  beforeEach(() => {
    ...
    contribService = injector.get<ContribService>(ContribService);
  ...
  describe('#contributors', () => {
    ...
    it('should have expected "GDE" contribs in order', () => {
      ...
      const expectedAngularNames = [testData.gkalpak, testData.kapunahelewong]
        .map(l => l.name)
        .join(',');
