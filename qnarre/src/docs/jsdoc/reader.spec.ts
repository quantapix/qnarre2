...
let srcJsContent = require("../mocks/_test-data/srcJsFile.js");
let docsFromJsContent = require("../mocks/_test-data/docsFromJsFile");
...
describe("jsdoc fileReader", () => {
  ...
  describe("getDocs", () => {
    ...
    it("should understand ES6 features", () => {
      ...
      const docs = fileReader.getDocs(fileInfo);
      expect(fileInfo.ast.body[0]).toEqual(
        jasmine.objectContaining({
    ...
    it("should cope with invalid JavaScript", () => {
      ...
      expect(() => {
        ...
        'JavaScript error in file "some/file.js"" [line 13, column 3]: "Unexpected identifier"'
      );
    });
  });
});
