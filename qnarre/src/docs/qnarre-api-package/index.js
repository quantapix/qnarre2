...
module.exports = new Package('qnarre-api', [basePackage, typeScriptPackage])
   ...
   */
  .factory(function API_DOC_TYPES(
    API_DOC_TYPES_TO_RENDER,
    API_CONTAINED_DOC_TYPES
  ) {
  ...
  .config(function(
    ...
    computePathsProcessor.pathTemplates.push({
      docTypes: EXPORT_DOC_TYPES.concat([
        'decorator',
        'directive',
        'ngmodule',
        'pipe'
  ...
  .config(function(
    ...
    convertToJsonProcessor.docTypes = convertToJsonProcessor.docTypes.concat(
      API_DOC_TYPES_TO_RENDER
    );
    postProcessHtml.docTypes = convertToJsonProcessor.docTypes.concat(
      API_DOC_TYPES_TO_RENDER
    );
