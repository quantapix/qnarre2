...
describe('qnarre-api-package: computeApiBreadCrumbs processor', () => {
  ...
  it('should attach a breadCrumbs property to each of the API_DOC_TYPES_TO_RENDER docs', () => {
    ...
    const coreTestingPackage = {
      docType: 'package',
      name: '@angular/core/testing',
      id: 'core/testing',
      path: 'core/testing',
      packageInfo: { primary: corePackage }
    };
    const testRequestClass = {
      docType: 'class',
      name: 'InjectSetupWrapper',
      path: 'core/testing/test_bed',
      moduleDoc: coreTestingPackage
    };
    ...
    const docs = [
      {
        docType: 'class',
        name: 'ClassA',
        path: 'module-1/class-a',
        moduleDoc: { id: 'moduleOne', path: 'module-1' }
      },
      {
        docType: 'interface',
        name: 'InterfaceB',
        path: 'module-2/interface-b',
        moduleDoc: { id: 'moduleTwo', path: 'module-2' }
      },
