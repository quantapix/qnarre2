...
describe('processPackages processor', () => {
  it('should be available on the injector', () => {
    ...
    expect(processor.$runAfter).toEqual([
      'processAliasDocs',
      'collectPackageContentDocsProcessor'
    ]);
  ...
  it('should partition the exports of packages into groups, sorted by id', () => {
    ...
    expect(docs[0].pipes).toEqual([{ docType: 'pipe', id: 'pipe-1' }]);
    ...
    const docs = [
      {
        ...
        docType: 'module',
        id: 'package-1',
        exports: [{ docType: 'class', id: 'class-1', deprecated: true }]
      },
      {
        fileInfo: { filePath: 'some/package-1/sub-1index' },
        docType: 'module',
        id: 'package-1/sub-1',
        exports: [{ docType: 'class', id: 'class-2', deprecated: true }]
      },
      {
        fileInfo: { filePath: 'some/package-2/index' },
        docType: 'module',
  ...
  it('should compute the deprecated status of packages', () => {
    const docs = [
      ...
      },
      {
        ...
        docType: 'module',
        id: 'package-2',
        exports: [{ docType: 'class', id: 'class-3', deprecated: true }]
      },
      {
        fileInfo: { filePath: 'some/package-2/sub-1index' },
        docType: 'module',
        id: 'package-2/sub-1',
        exports: [{ docType: 'class', id: 'class-4', deprecated: false }]
      },
      {
        fileInfo: { filePath: 'some/package-3/index' },
        docType: 'module',
        id: 'package-3',
        exports: [{ docType: 'class', id: 'class-5', deprecated: false }]
      },
      {
        fileInfo: { filePath: 'some/package-3/sub-1index' },
        docType: 'module',
        id: 'package-3/sub-1',
        exports: [{ docType: 'class', id: 'class-6', deprecated: true }]
      }
    ];
    const processor = processorFactory({ packageContentFiles: {} });
    processor.$process(docs);
