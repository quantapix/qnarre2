...
export const enum JsxFlags {
  None = 0,
  IntrinsicNamedElem = 1 << 0,
  IntrinsicIndexedElem = 1 << 1,
  IntrinsicElem = IntrinsicNamedElem | IntrinsicIndexedElem,
}
...
export const enum ListFormat {
  ...
  SingleLineTupleTypeElems = CommaDelimited | SpaceBetweenSiblings | SingleLine,
  MultiLineTupleTypeElems = CommaDelimited | Indented | SpaceBetweenSiblings | MultiLine,
  UnionTypeConstituents = BarDelimited | SpaceBetweenSiblings | SingleLine,
  IntersectionTypeConstituents = AmpersandDelimited | SpaceBetweenSiblings | SingleLine,
  ObjectBindingPatternElems = SingleLine | AllowTrailingComma | SpaceBetweenBraces | CommaDelimited | SpaceBetweenSiblings | NoSpaceIfEmpty,
  ArrayBindingPatternElems = SingleLine | AllowTrailingComma | CommaDelimited | SpaceBetweenSiblings | NoSpaceIfEmpty,
  ...
  NamedImportsOrExportsElems = CommaDelimited | SpaceBetweenSiblings | AllowTrailingComma | SingleLine | SpaceBetweenBraces | NoSpaceIfEmpty,
  JsxElemOrFragmentChildren = SingleLine | NoInterveningComments,
  JsxElemAttributes = SingleLine | SpaceBetweenSiblings | NoInterveningComments,
