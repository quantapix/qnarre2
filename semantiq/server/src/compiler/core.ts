...
export abstract class NodeIs extends qb.TextRange implements qt.Node {
  kind!: any;
  node(k: Syntax) {
  ...
  typeAlias(n: Node): this is qt.JSDocTypedefTag | qt.JSDocCallbackTag | qt.JSDocEnumTag | TypeAliasDeclaration {
