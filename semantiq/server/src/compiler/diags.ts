...
export const diags = {
  ...
  An_index_signature_cannot_have_a_trailing_comma: diag(1025, DiagnosticCategory.Error, 'An_index_signature_cannot_have_a_trailing_comma_1025', 'An index signature cannot have a trailing comma.'),
  ...
  The_return_type_of_an_async_function_or_method_must_be_the_global_Promise_T_type_Did_you_mean_to_write_Promise_0: diag(
    1064,
    DiagnosticCategory.Error,
  ...
  export_Asterisk_does_not_re_export_a_default: diag(1195, DiagnosticCategory.Error, 'export_Asterisk_does_not_re_export_a_default_1195', "'export *' does not re-export a default."),
  ...
  A_rest_element_must_be_last_in_a_tuple_type: diag(1256, DiagnosticCategory.Error, 'A_rest_element_must_be_last_in_a_tuple_type_1256', 'A rest element must be last in a tuple type.'),
  ...
  A_label_is_not_allowed_here: diag(1344, DiagnosticCategory.Error, 'A_label_is_not_allowed_here_1344', "'A label is not allowed here."),
  ...
  Non_simple_parameter_declared_here: diag(1348, DiagnosticCategory.Error, 'Non_simple_parameter_declared_here_1348', 'Non-simple parameter declared here.'),
  use_strict_directive_used_here: diag(1349, DiagnosticCategory.Error, 'use_strict_directive_used_here_1349', "'use strict' directive used here."),
  ...
  Did_you_mean_to_mark_this_function_as_async: diag(1356, DiagnosticCategory.Error, 'Did_you_mean_to_mark_this_function_as_async_1356', "Did you mean to mark this function as 'async'?"),
  ...
  Did_you_mean_to_parenthesize_this_function_type: diag(1360, DiagnosticCategory.Error, 'Did_you_mean_to_parenthesize_this_function_type_1360', 'Did you mean to parenthesize this function type?'),
  ...
  Convert_to_type_only_export: diag(1364, DiagnosticCategory.Message, 'Convert_to_type_only_export_1364', 'Convert to type-only export'),
  ...
  Split_into_two_separate_import_declarations: diag(1366, DiagnosticCategory.Message, 'Split_into_two_separate_import_declarations_1366', 'Split into two separate import declarations'),
  Split_all_invalid_type_only_imports: diag(1367, DiagnosticCategory.Message, 'Split_all_invalid_type_only_imports_1367', 'Split all invalid type-only imports'),
  ...
  Only_ECMAScript_imports_may_use_import_type: diag(1370, DiagnosticCategory.Error, 'Only_ECMAScript_imports_may_use_import_type_1370', "Only ECMAScript imports may use 'import type'."),
  ...
  Convert_to_type_only_import: diag(1373, DiagnosticCategory.Message, 'Convert_to_type_only_import_1373', 'Convert to type-only import'),
  ...
  _0_was_imported_here: diag(1376, DiagnosticCategory.Message, '_0_was_imported_here_1376', "'{0}' was imported here."),
  _0_was_exported_here: diag(1377, DiagnosticCategory.Message, '_0_was_exported_here_1377', "'{0}' was exported here."),
  ...
  Unexpected_token_Did_you_mean_or_rbrace: diag(1381, DiagnosticCategory.Error, 'Unexpected_token_Did_you_mean_or_rbrace_1381', "Unexpected token. Did you mean `{'}'}` or `&rbrace;`?"),
  Unexpected_token_Did_you_mean_or_gt: diag(1382, DiagnosticCategory.Error, 'Unexpected_token_Did_you_mean_or_gt_1382', "Unexpected token. Did you mean `{'>'}` or `&gt;`?"),
  Only_named_exports_may_use_export_type: diag(1383, DiagnosticCategory.Error, 'Only_named_exports_may_use_export_type_1383', "Only named exports may use 'export type'."),
  ...
  Parameter_0_cannot_reference_itself: diag(2372, DiagnosticCategory.Error, 'Parameter_0_cannot_reference_itself_2372', "Parameter '{0}' cannot reference itself."),
  Parameter_0_cannot_reference_identifier_1_declared_after_it: diag(
    2373,
    DiagnosticCategory.Error,
  ...
  Rest_signatures_are_incompatible: diag(2572, DiagnosticCategory.Error, 'Rest_signatures_are_incompatible_2572', 'Rest signatures are incompatible.'),
  ...
  A_rest_element_type_must_be_an_array_type: diag(2574, DiagnosticCategory.Error, 'A_rest_element_type_must_be_an_array_type_2574', 'A rest element type must be an array type.'),
  ...
  Property_0_is_a_static_member_of_type_1: diag(2576, DiagnosticCategory.Error, 'Property_0_is_a_static_member_of_type_1_2576', "Property '{0}' is a static member of type '{1}'"),
  ...
  Unused_ts_expect_error_directive: diag(2578, DiagnosticCategory.Error, 'Unused_ts_expect_error_directive_2578', "Unused '@ts-expect-error' directive."),
  ...
  Property_0_is_used_before_its_initialization: diag(2729, DiagnosticCategory.Error, 'Property_0_is_used_before_its_initialization_2729', "Property '{0}' is used before its initialization."),
  An_arrow_function_cannot_have_a_this_parameter: diag(2730, DiagnosticCategory.Error, 'An_arrow_function_cannot_have_a_this_parameter_2730', "An arrow function cannot have a 'this' parameter."),
  ...
  The_first_export_default_is_here: diag(2752, DiagnosticCategory.Error, 'The_first_export_default_is_here_2752', 'The first export default is here.'),
  Another_export_default_is_here: diag(2753, DiagnosticCategory.Error, 'Another_export_default_is_here_2753', 'Another export default is here.'),
  super_may_not_use_type_arguments: diag(2754, DiagnosticCategory.Error, 'super_may_not_use_type_arguments_2754', "'super' may not use type arguments."),
  ...
  The_0_property_of_an_iterator_must_be_a_method: diag(2767, DiagnosticCategory.Error, 'The_0_property_of_an_iterator_must_be_a_method_2767', "The '{0}' property of an iterator must be a method."),
  ...
  Did_you_forget_to_use_await: diag(2773, DiagnosticCategory.Error, 'Did_you_forget_to_use_await_2773', "Did you forget to use 'await'?"),
  ...
  This_spread_always_overwrites_this_property: diag(2785, DiagnosticCategory.Error, 'This_spread_always_overwrites_this_property_2785', 'This spread always overwrites this property.'),
  _0_cannot_be_used_as_a_JSX_component: diag(2786, DiagnosticCategory.Error, '_0_cannot_be_used_as_a_JSX_component_2786', "'{0}' cannot be used as a JSX component."),
  Its_return_type_0_is_not_a_valid_JSX_element: diag(2787, DiagnosticCategory.Error, 'Its_return_type_0_is_not_a_valid_JSX_element_2787', "Its return type '{0}' is not a valid JSX element."),
  Its_instance_type_0_is_not_a_valid_JSX_element: diag(2788, DiagnosticCategory.Error, 'Its_instance_type_0_is_not_a_valid_JSX_element_2788', "Its instance type '{0}' is not a valid JSX element."),
  Its_element_type_0_is_not_a_valid_JSX_element: diag(2789, DiagnosticCategory.Error, 'Its_element_type_0_is_not_a_valid_JSX_element_2789', "Its element type '{0}' is not a valid JSX element."),
  The_operand_of_a_delete_operator_must_be_optional: diag(
    2790,
    DiagnosticCategory.Error,
    'The_operand_of_a_delete_operator_must_be_optional_2790',
    "The operand of a 'delete' operator must be optional."
  ),
  Exponentiation_cannot_be_performed_on_bigint_values_unless_the_target_option_is_set_to_es2016_or_later: diag(
    2791,
    DiagnosticCategory.Error,
  ...
  Pattern_0_can_have_at_most_one_Asterisk_character: diag(
    5061,
    DiagnosticCategory.Error,
  ...
  Unknown_build_option_0: diag(5072, DiagnosticCategory.Error, 'Unknown_build_option_0_5072', "Unknown build option '{0}'."),
  Build_option_0_requires_a_value_of_type_1: diag(5073, DiagnosticCategory.Error, 'Build_option_0_requires_a_value_of_type_1_5073', "Build option '{0}' requires a value of type {1}."),
  ...
  Unknown_build_option_0_Did_you_mean_1: diag(5077, DiagnosticCategory.Error, 'Unknown_build_option_0_Did_you_mean_1_5077', "Unknown build option '{0}'. Did you mean '{1}'?"),
  Unknown_watch_option_0: diag(5078, DiagnosticCategory.Error, 'Unknown_watch_option_0_5078', "Unknown watch option '{0}'."),
  Unknown_watch_option_0_Did_you_mean_1: diag(5079, DiagnosticCategory.Error, 'Unknown_watch_option_0_Did_you_mean_1_5079', "Unknown watch option '{0}'. Did you mean '{1}'?"),
  Watch_option_0_requires_a_value_of_type_1: diag(5080, DiagnosticCategory.Error, 'Watch_option_0_requires_a_value_of_type_1_5080', "Watch option '{0}' requires a value of type {1}."),
  ...
  Tuple_members_must_all_have_names_or_all_not_have_names: diag(
    5084,
    DiagnosticCategory.Error,
    'Tuple_members_must_all_have_names_or_all_not_have_names_5084',
    'Tuple members must all have names or all not have names.'
  ),
  A_tuple_member_cannot_be_both_optional_and_rest: diag(5085, DiagnosticCategory.Error, 'A_tuple_member_cannot_be_both_optional_and_rest_5085', 'A tuple member cannot be both optional and rest.'),
  A_labeled_tuple_element_is_declared_as_optional_with_a_question_mark_after_the_name_and_before_the_colon_rather_than_after_the_type: diag(
    5086,
    DiagnosticCategory.Error,
  ...
  A_labeled_tuple_element_is_declared_as_rest_with_a_before_the_name_rather_than_before_the_type: diag(
    5087,
    DiagnosticCategory.Error,
  ...
  Conflicts_are_in_this_file: diag(6201, DiagnosticCategory.Message, 'Conflicts_are_in_this_file_6201', 'Conflicts are in this file.'),
  ...
  package_json_had_a_falsy_0_field: diag(6220, DiagnosticCategory.Message, 'package_json_had_a_falsy_0_field_6220', "'package.json' had a falsy '{0}' field."),
  ...
  Emit_class_fields_with_Define_instead_of_Set: diag(6222, DiagnosticCategory.Message, 'Emit_class_fields_with_Define_instead_of_Set_6222', 'Emit class fields with Define instead of Set.'),
  Generates_a_CPU_profile: diag(6223, DiagnosticCategory.Message, 'Generates_a_CPU_profile_6223', 'Generates a CPU profile.'),
  Disable_solution_searching_for_this_project: diag(6224, DiagnosticCategory.Message, 'Disable_solution_searching_for_this_project_6224', 'Disable solution searching for this project.'),
  ...
  Declaration_augments_declaration_in_another_file_This_cannot_be_serialized: diag(
    6232,
    DiagnosticCategory.Error,
  ...
  This_is_the_declaration_being_augmented_Consider_moving_the_augmenting_declaration_into_the_same_file: diag(
    6233,
    DiagnosticCategory.Error,
    'This_is_the_declaration_being_augmented_Consider_moving_the_augmenting_declaration_into_the_same_fil_6233',
    'This is the declaration being augmented. Consider moving the augmenting declaration into the same file.'
  ),
  This_expression_is_not_callable_because_it_is_a_get_accessor_Did_you_mean_to_use_it_without: diag(
    6234,
    DiagnosticCategory.Error,
    'This_expression_is_not_callable_because_it_is_a_get_accessor_Did_you_mean_to_use_it_without_6234',
    "This expression is not callable because it is a 'get' accessor. Did you mean to use it without '()'?"
  ),
  Projects_to_reference: diag(6300, DiagnosticCategory.Message, 'Projects_to_reference_6300', 'Projects to reference'),
  Enable_project_compilation: diag(6302, DiagnosticCategory.Message, 'Enable_project_compilation_6302', 'Enable project compilation'),
  ...
  Output_file_0_from_project_1_does_not_exist: diag(6309, DiagnosticCategory.Error, 'Output_file_0_from_project_1_does_not_exist_6309', "Output file '{0}' from project '{1}' does not exist"),
  ...
  Projects_in_this_build_Colon_0: diag(6355, DiagnosticCategory.Message, 'Projects_in_this_build_Colon_0_6355', 'Projects in this build: {0}'),
  ...
  A_non_dry_build_would_build_project_0: diag(6357, DiagnosticCategory.Message, 'A_non_dry_build_would_build_project_0_6357', "A non-dry build would build project '{0}'"),
  Building_project_0: diag(6358, DiagnosticCategory.Message, 'Building_project_0_6358', "Building project '{0}'..."),
  Updating_output_timestamps_of_project_0: diag(6359, DiagnosticCategory.Message, 'Updating_output_timestamps_of_project_0_6359', "Updating output timestamps of project '{0}'..."),
  ...
  Project_0_is_up_to_date: diag(6361, DiagnosticCategory.Message, 'Project_0_is_up_to_date_6361', "Project '{0}' is up to date"),
  ...
  Delete_the_outputs_of_all_projects: diag(6365, DiagnosticCategory.Message, 'Delete_the_outputs_of_all_projects_6365', 'Delete the outputs of all projects'),
  Enable_verbose_logging: diag(6366, DiagnosticCategory.Message, 'Enable_verbose_logging_6366', 'Enable verbose logging'),
  ...
  Options_0_and_1_cannot_be_combined: diag(6370, DiagnosticCategory.Error, 'Options_0_and_1_cannot_be_combined_6370', "Options '{0}' and '{1}' cannot be combined."),
  ...
  Updating_output_of_project_0: diag(6373, DiagnosticCategory.Message, 'Updating_output_of_project_0_6373', "Updating output of project '{0}'..."),
  ...
  Enable_incremental_compilation: diag(6378, DiagnosticCategory.Message, 'Enable_incremental_compilation_6378', 'Enable incremental compilation'),
  ...
  import_can_only_be_used_in_TypeScript_files: diag(8002, DiagnosticCategory.Error, 'import_can_only_be_used_in_TypeScript_files_8002', "'import ... =' can only be used in TypeScript files."),
  export_can_only_be_used_in_TypeScript_files: diag(8003, DiagnosticCategory.Error, 'export_can_only_be_used_in_TypeScript_files_8003', "'export =' can only be used in TypeScript files."),
  ...
  Remove_unused_declaration_for_Colon_0: diag(90004, DiagnosticCategory.Message, 'Remove_unused_declaration_for_Colon_0_90004', "Remove unused declaration for: '{0}'"),
  ...
  Remove_destructuring: diag(90009, DiagnosticCategory.Message, 'Remove_destructuring_90009', 'Remove destructuring'),
  Remove_variable_statement: diag(90010, DiagnosticCategory.Message, 'Remove_variable_statement_90010', 'Remove variable statement'),
  Remove_template_tag: diag(90011, DiagnosticCategory.Message, 'Remove_template_tag_90011', 'Remove template tag'),
  Remove_type_parameters: diag(90012, DiagnosticCategory.Message, 'Remove_type_parameters_90012', 'Remove type parameters'),
  ...
  Replace_infer_0_with_unknown: diag(90030, DiagnosticCategory.Message, 'Replace_infer_0_with_unknown_90030', "Replace 'infer {0}' with 'unknown'"),
  Replace_all_unused_infer_with_unknown: diag(90031, DiagnosticCategory.Message, 'Replace_all_unused_infer_with_unknown_90031', "Replace all unused 'infer' with 'unknown'"),
  Import_default_0_from_module_1: diag(90032, DiagnosticCategory.Message, 'Import_default_0_from_module_1_90032', 'Import default \'{0}\' from module "{1}"'),
  ...
  Add_parameter_name: diag(90034, DiagnosticCategory.Message, 'Add_parameter_name_90034', 'Add parameter name'),
  Declare_private_property_0: diag(90035, DiagnosticCategory.Message, 'Declare_private_property_0_90035', "Declare private property '{0}'"),
  Replace_0_with_Promise_1: diag(90036, DiagnosticCategory.Message, 'Replace_0_with_Promise_1_90036', "Replace '{0}' with 'Promise<{1}>'"),
  Fix_all_incorrect_return_type_of_an_async_functions: diag(
    90037,
    DiagnosticCategory.Message,
    'Fix_all_incorrect_return_type_of_an_async_functions_90037',
    'Fix all incorrect return type of an async functions'
  ),
  Declare_private_method_0: diag(90038, DiagnosticCategory.Message, 'Declare_private_method_0_90038', "Declare private method '{0}'"),
  Declare_a_private_field_named_0: diag(90053, DiagnosticCategory.Message, 'Declare_a_private_field_named_0_90053', "Declare a private field named '{0}'."),
  ...
  Move_to_a_new_file: diag(95049, DiagnosticCategory.Message, 'Move_to_a_new_file_95049', 'Move to a new file'),
  Remove_unreachable_code: diag(95050, DiagnosticCategory.Message, 'Remove_unreachable_code_95050', 'Remove unreachable code'),
  Remove_all_unreachable_code: diag(95051, DiagnosticCategory.Message, 'Remove_all_unreachable_code_95051', 'Remove all unreachable code'),
  Add_missing_typeof: diag(95052, DiagnosticCategory.Message, 'Add_missing_typeof_95052', "Add missing 'typeof'"),
  Remove_unused_label: diag(95053, DiagnosticCategory.Message, 'Remove_unused_label_95053', 'Remove unused label'),
  Remove_all_unused_labels: diag(95054, DiagnosticCategory.Message, 'Remove_all_unused_labels_95054', 'Remove all unused labels'),
  ...
  Add_missing_enum_member_0: diag(95063, DiagnosticCategory.Message, 'Add_missing_enum_member_0_95063', "Add missing enum member '{0}'"),
  Add_all_missing_imports: diag(95064, DiagnosticCategory.Message, 'Add_all_missing_imports_95064', 'Add all missing imports'),
  Convert_to_async_function: diag(95065, DiagnosticCategory.Message, 'Convert_to_async_function_95065', 'Convert to async function'),
  Convert_all_to_async_functions: diag(95066, DiagnosticCategory.Message, 'Convert_all_to_async_functions_95066', 'Convert all to async functions'),
  Add_missing_call_parentheses: diag(95067, DiagnosticCategory.Message, 'Add_missing_call_parentheses_95067', 'Add missing call parentheses'),
  Add_all_missing_call_parentheses: diag(95068, DiagnosticCategory.Message, 'Add_all_missing_call_parentheses_95068', 'Add all missing call parentheses'),
  ...
  Add_missing_new_operator_to_call: diag(95071, DiagnosticCategory.Message, 'Add_missing_new_operator_to_call_95071', "Add missing 'new' operator to call"),
  Add_missing_new_operator_to_all_calls: diag(95072, DiagnosticCategory.Message, 'Add_missing_new_operator_to_all_calls_95072', "Add missing 'new' operator to all calls"),
  Add_names_to_all_parameters_without_names: diag(95073, DiagnosticCategory.Message, 'Add_names_to_all_parameters_without_names_95073', 'Add names to all parameters without names'),
  ...
  Convert_parameters_to_destructured_object: diag(95075, DiagnosticCategory.Message, 'Convert_parameters_to_destructured_object_95075', 'Convert parameters to destructured object'),
  Allow_accessing_UMD_globals_from_modules: diag(95076, DiagnosticCategory.Message, 'Allow_accessing_UMD_globals_from_modules_95076', 'Allow accessing UMD globals from modules.'),
  Extract_type: diag(95077, DiagnosticCategory.Message, 'Extract_type_95077', 'Extract type'),
  Extract_to_type_alias: diag(95078, DiagnosticCategory.Message, 'Extract_to_type_alias_95078', 'Extract to type alias'),
  Extract_to_typedef: diag(95079, DiagnosticCategory.Message, 'Extract_to_typedef_95079', 'Extract to typedef'),
  Infer_this_type_of_0_from_usage: diag(95080, DiagnosticCategory.Message, 'Infer_this_type_of_0_from_usage_95080', "Infer 'this' type of '{0}' from usage"),
  Add_const_to_unresolved_variable: diag(95081, DiagnosticCategory.Message, 'Add_const_to_unresolved_variable_95081', "Add 'const' to unresolved variable"),
  Add_const_to_all_unresolved_variables: diag(95082, DiagnosticCategory.Message, 'Add_const_to_all_unresolved_variables_95082', "Add 'const' to all unresolved variables"),
  Add_await: diag(95083, DiagnosticCategory.Message, 'Add_await_95083', "Add 'await'"),
  Add_await_to_initializer_for_0: diag(95084, DiagnosticCategory.Message, 'Add_await_to_initializer_for_0_95084', "Add 'await' to initializer for '{0}'"),
  Fix_all_expressions_possibly_missing_await: diag(95085, DiagnosticCategory.Message, 'Fix_all_expressions_possibly_missing_await_95085', "Fix all expressions possibly missing 'await'"),
  Remove_unnecessary_await: diag(95086, DiagnosticCategory.Message, 'Remove_unnecessary_await_95086', "Remove unnecessary 'await'"),
  Remove_all_unnecessary_uses_of_await: diag(95087, DiagnosticCategory.Message, 'Remove_all_unnecessary_uses_of_await_95087', "Remove all unnecessary uses of 'await'"),
  Enable_the_jsx_flag_in_your_configuration_file: diag(95088, DiagnosticCategory.Message, 'Enable_the_jsx_flag_in_your_configuration_file_95088', "Enable the '--jsx' flag in your configuration file"),
  Add_await_to_initializers: diag(95089, DiagnosticCategory.Message, 'Add_await_to_initializers_95089', "Add 'await' to initializers"),
  Extract_to_interface: diag(95090, DiagnosticCategory.Message, 'Extract_to_interface_95090', 'Extract to interface'),
  Convert_to_a_bigint_numeric_literal: diag(95091, DiagnosticCategory.Message, 'Convert_to_a_bigint_numeric_literal_95091', 'Convert to a bigint numeric literal'),
  Convert_all_to_bigint_numeric_literals: diag(95092, DiagnosticCategory.Message, 'Convert_all_to_bigint_numeric_literals_95092', 'Convert all to bigint numeric literals'),
  Convert_const_to_let: diag(95093, DiagnosticCategory.Message, 'Convert_const_to_let_95093', "Convert 'const' to 'let'"),
  Prefix_with_declare: diag(95094, DiagnosticCategory.Message, 'Prefix_with_declare_95094', "Prefix with 'declare'"),
  ...
  Convert_to_template_string: diag(95096, DiagnosticCategory.Message, 'Convert_to_template_string_95096', 'Convert to template string'),
  Add_export_to_make_this_file_into_a_module: diag(95097, DiagnosticCategory.Message, 'Add_export_to_make_this_file_into_a_module_95097', "Add 'export {}' to make this file into a module"),
  ...
  Add_class_tag: diag(95102, DiagnosticCategory.Message, 'Add_class_tag_95102', "Add '@class' tag"),
  Add_this_tag: diag(95103, DiagnosticCategory.Message, 'Add_this_tag_95103', "Add '@this' tag"),
  Add_this_parameter: diag(95104, DiagnosticCategory.Message, 'Add_this_parameter_95104', "Add 'this' parameter."),
  ...
  Fix_all_implicit_this_errors: diag(95107, DiagnosticCategory.Message, 'Fix_all_implicit_this_errors_95107', "Fix all implicit-'this' errors"),
  ...
  Add_a_return_statement: diag(95111, DiagnosticCategory.Message, 'Add_a_return_statement_95111', 'Add a return statement'),
  Remove_braces_from_arrow_function_body: diag(95112, DiagnosticCategory.Message, 'Remove_braces_from_arrow_function_body_95112', 'Remove braces from arrow function body'),
  ...
  Add_all_missing_return_statement: diag(95114, DiagnosticCategory.Message, 'Add_all_missing_return_statement_95114', 'Add all missing return statement'),
  Remove_braces_from_all_arrow_function_bodies_with_relevant_issues: diag(
    95115,
    DiagnosticCategory.Message,
  ...
  Wrap_all_object_literal_with_parentheses: diag(95116, DiagnosticCategory.Message, 'Wrap_all_object_literal_with_parentheses_95116', 'Wrap all object literal with parentheses'),
  Move_labeled_tuple_element_modifiers_to_labels: diag(95117, DiagnosticCategory.Message, 'Move_labeled_tuple_element_modifiers_to_labels_95117', 'Move labeled tuple element modifiers to labels'),
  Convert_overload_list_to_single_signature: diag(95118, DiagnosticCategory.Message, 'Convert_overload_list_to_single_signature_95118', 'Convert overload list to single signature'),
  Generate_get_and_set_accessors_for_all_overriding_properties: diag(
    95119,
    DiagnosticCategory.Message,
  ...
  Classes_may_not_have_a_field_named_constructor: diag(18006, DiagnosticCategory.Error, 'Classes_may_not_have_a_field_named_constructor_18006', "Classes may not have a field named 'constructor'."),
  ...
  Private_identifiers_cannot_be_used_as_parameters: diag(18009, DiagnosticCategory.Error, 'Private_identifiers_cannot_be_used_as_parameters_18009', 'Private identifiers cannot be used as parameters'),
  ...
  constructor_is_a_reserved_word: diag(18012, DiagnosticCategory.Error, 'constructor_is_a_reserved_word_18012', "'#constructor' is a reserved word."),
  ...
  The_shadowing_declaration_of_0_is_defined_here: diag(18017, DiagnosticCategory.Error, 'The_shadowing_declaration_of_0_is_defined_here_18017', "The shadowing declaration of '{0}' is defined here"),
