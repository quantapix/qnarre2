namespace core {
  ...
  export namespace syntax {
    ...
    export const strToKey = new QMap(keywords);
    const strToTok = new QMap<Syntax>({
      ...keywords,
    ...
    export const get = new (class {
      ...
      leadingCommentRanges(s: string, pos: number): CommentRange[] | undefined {
        return reduceEachLeadingCommentRange(s, pos, appendCommentRange, undefined, undefined);
      }
      trailingCommentRanges(s: string, pos: number): CommentRange[] | undefined {
    ...
    export function appendCommentRange(pos: number, end: number, kind: CommentKind, hasTrailingNewLine: boolean, _?: any, cs?: CommentRange[]) {
      if (!cs) cs = [];
