namespace qnr {
  ...
  export namespace Scanner {
    ...
    export function escUnderscores(s: string): __String {
      return (s.length >= 2 && s.charCodeAt(0) === Codes._ && s.charCodeAt(1) === Codes._ ? '_' + s : s) as __String;
    }
    export function unescUnderscores(x: __String): string {
      const s = x as string;
    ...
    export function posOf(starts: readonly number[], line: number, char: number, debug?: string, edits?: true) {
