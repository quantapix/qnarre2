      ...
      new Block(
        [
          ...
          new qc.ForInStatement(
            ...
            new Block([
              setEmitFlags(
                new qc.IfStatement(condition, new qc.ExpressionStatement(qf.create.assignment(new qs.ElementAccessExpression(exports, n), new qs.ElementAccessExpression(m, n)))),
                EmitFlags.SingleLine
              ),
            ])
          ),
